        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="panel panel-heading">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="fw-bold">Thêm kích thước sản phẩm</h2>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form action="{{ route('size.product-manager.store') }}" 
                    class="form-horizontal"  method="POST">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Nhập kích thước sản phẩm" name="size"
                                    class="form-control input-md border border-secondary px-2" value="{{ old('size') }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group my-2">
                            <div class="col-md-8 offset-md-4">
                                <button class="btn btn-success float-end" type="Submit">Thêm kích thước sản phẩm</button>
                            </div>
                        </div>
                    </form>
                </div>
