        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="panel panel-heading">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="fw-bold">Sửa mã giảm giá</h2>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form action="{{ route('update-coupon-manager', ['id' => $coupon->id]) }}" 
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Nhập tên mã giảm giá" name="code"
                                    class="form-control input-md border border-secondary px-2" value="{{ $coupon->code }}"/>
                            </div>
                        </div>

                        <div class="form-group row my-2">
                            <label for="type" class="col-md-4 control-label fw-bold">Chọn kiểu</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Nhập giá trị của mã" name="coupon_value"
                                    class="form-control input-md border border-secondary px-2" value="{{ $coupon->coupon_value }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" placeholder="Nhập giá trị tối thiểu của giỏ hàng" name="cart_value"
                                    class="form-control input-md border border-secondary px-2" value="{{ $coupon->cart_value }}"/>
                            </div>
                        </div>

                        <div class="form-group my-2">
                            <div class="col-md-8 offset-md-4">
                                <button class="btn btn-success float-end" type="Submit">Sửa</button>
                            </div>
                        </div>
                    </form>
                </div>
