...
@section('content')
    <div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="col-md-6 float-end">
                                <a href="{{ route('order-history') }}" class="btn btn-dark rounded-0 float-end mx-1" style="transform: translateY(-40px);">Quay lại</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $product)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('img/product') }}/{{ $product->product->product_image }}" class="" style="height: 100px" alt></td>
        ...
        @else
            <p class="text-center text-success">Đơn hàng của bạn đã xác nhận</p>
        @endif
    </div>
@endsection